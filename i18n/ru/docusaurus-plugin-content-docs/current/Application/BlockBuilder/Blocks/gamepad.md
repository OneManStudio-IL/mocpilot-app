...
- Выбор стика: `влево` / `вправо`
- Выбор направления/состояния: `вверх`, `вниз`, `влево`, `вправо`, `движение`, `отпущена`
- Тип: событийный блок
...
- Используйте блоки событий для мгновенной реакции на изменения ввода.
- Используйте блоки значений для постоянного опроса в циклах и вычислениях управления.
- Для плавного управления моторами применяйте мертвую зону и масштабирование значений стиков/триггеров.
- Комбинируйте с блоками широковещательных сообщений, чтобы разделить обработку ввода и исполнительную логику.

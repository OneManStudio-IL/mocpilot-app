...
- Ініціалізуйте важливі змінні на старті програми.
- Використовуйте `change by` для інкрементальних змін, щоб уникнути повторюваної get/set логіки.
- Використовуйте зрозумілі назви змінних (`speed_target`, `is_armed`, `lap_count`).

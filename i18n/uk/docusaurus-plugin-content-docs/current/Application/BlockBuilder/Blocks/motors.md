...
- Використовуйте `go to position` для абсолютних цілей, а `go to relative position` для інкрементального руху.
- Налаштовуйте прискорення/уповільнення для плавніших стартів і зупинок.
- Увімкніть виявлення заклинювання, якщо механізм може заклинити під навантаженням.

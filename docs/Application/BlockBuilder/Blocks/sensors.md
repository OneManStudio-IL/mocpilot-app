...
### `Technic color and distance sensor` {#block_hubs_all_sensors_port_technic_sensor_distance}
...
Returns distance values from a Technic color and distance sensor.
...
Triggers/checks distance condition for a Technic color and distance sensor.
...
Returns detected color value from a Technic color and distance sensor.
